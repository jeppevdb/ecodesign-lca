...
from impact_report_generation.src.utils.selectors import get_scenarios, characterized_impact_selector_with_score, country_selector, local_design_component_selector, impact_unit_label
pn.extension("plotly")
...
def build():
    ...
    def view(global_sel, local_sel, impact_cat, country):
        ...
        "component == @comp and design_variation_component==@comp"
        )
    ...
    # 4) Layout
    header = pane.Markdown("## Component-Level Sunburst — by Scenario")
    controls1 = pn.Row(
        global_display,
        local_comp,
        sizing_mode="stretch_width"
